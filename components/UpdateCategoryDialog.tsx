    ...
    export default function UpdateCategoryDialog({ open, setOpen, category }: { open: boolean, setOpen: (v: boolean) => void, category: { _id: string, name: string, slug: string, brand?: { _id: string } } }) {
