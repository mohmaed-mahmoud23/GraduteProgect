      ...
      <div className="border-t border-border mt-6">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
          <div className="flex flex-col gap-1 text-center md:text-left">
            <span>© 2024 Paint & Light Service Platform. All rights reserved.</span>
            <span className="font-semibold text-primary/80">Mohamed Mahmoud Frontend Developer | Abdallah Backend Developer</span>
          </div>
