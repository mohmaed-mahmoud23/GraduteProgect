...
import { Loader2, Plus, Search, MoreVertical, LayoutGrid } from "lucide-react";
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative w-64">
                        ...
                        <Input placeholder="Search categories..." className="pl-10 h-11 rounded-xl bg-background/50 backdrop-blur-sm border-muted-foreground/20 focus-visible:ring-primary/30" />
                    </div>
                    <Button
                        onClick={() => router.push("/dashboard/categories/createcategory")}
            ...
            <div className="relative h-full">
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center min-h-[400px]">
                        ...
                        <p className="text-muted-foreground mt-4 font-medium">Loading categories...</p>
                    </div>
                ) : error ? (
                    <div className="flex flex-col items-center justify-center min-h-[400px] border-2 border-dashed rounded-3xl border-destructive/20 bg-destructive/5 p-10">
                        <p className="text-destructive font-semibold text-lg">Failed to load categories</p>
                    ...
                    <div className="flex flex-col items-center justify-center min-h-[400px] border-2 border-dashed rounded-3xl border-muted-foreground/20 bg-muted/5 p-10">
                        ...
                        <p className="text-muted-foreground text-xl font-medium">No categories found</p>
                        <Button variant="link" className="mt-2 text-primary" onClick={() => router.push("/dashboard/categories/createcategory")}>Create your first category</Button>
                    </div>
                ) : (
